...
public:
   ...
   */
  virtual void ToSortedVector(std::vector<DataType> *out, std::vector<long> *out_id=NULL) ;
protected:
  /**
   ...
   * out_id is an optional arg for output the IDs of the data stored in the tree.
   */
  virtual void _InOrder2Vec(AVLNode *n, std::vector<DataType> *out, std::vector<long> *out_id=NULL) ;
  /**
